    ...
    <div class="section">
        <div class="container">
            ...
            <div class="box">
                <div class="row">
                    <div class="col-3">
                        <img src="event/3.png" width="100%">
                    </div>
                    <div class="col-3" style="width: 70%;">
                        <h3 style="color: #000">workshop 3</h3>
                        <h4 style="text-align: left;">Rp. 50.000</h4>
                        <p>Deskripsi : <br>
                            kali ini kami dari handcraft mau mengadakan workshop yang sangat menarik,
                            workshop kali ini kita akan diajarkan bagaimana cara membuat gelang dengan
